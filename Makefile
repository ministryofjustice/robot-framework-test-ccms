...
run:
	robot --variablefile variables.py --outputdir results  --pythonpath  .  --listener robot_scripts\Support\keyword_output_formatter_listener.py --console verbose  --task $(task) $(t) robot_scripts
